...
namespace Day17
{
    public class Screen
    {
        ...
        public IEnumerable<(Screen s,int x,int y, bool v)> ForEach(Func<Screen,int,int,bool,bool> filter=null) 
        {
